...
The executive order specifies that the Director of National Intelligence and the Attorney General, along with other officials, must coordinate the release plans. It also clarifies that the order should not interfere with existing legal authorities or create enforceable rights against the U.S. government. This move is part of Trump's broader promise to end delays and provide the American people with the truth about these historical events.
